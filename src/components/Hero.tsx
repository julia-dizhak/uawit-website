...
const Hero = ({ backgroundImage, description, title, buttonName }: HeroType) => {
    ...
    <div className="relative bg-cover bg-center md:h-[40vh] flex flex-col justify-center items-center gap-4">
      ...
      <Container>
        <div className="mt-10 flex flex-col justify-center items-center md:mt-0">
          ...
          {buttonName && <Button buttonText={buttonName?.buttonText} handleClick={handleButtonClick} className={"mt-16"} />}
        </div>
      </Container>
    </div>
  );
